...
We can use likelihood-ratio testing to detect violation of Hardy-Weinberg equilibrium given disruptive selection. We will first model it with a multinomial distribution Multi(\textbf{X}:n, \textbf{\theta}): 
...
# wflow_publish('analysis/statistical_power.Rmd', 'please write commit message')
wflow_git_push()
```
